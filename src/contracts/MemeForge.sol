...
import "./componets/Factory.sol";
import "./componets/Pair.sol";
import "./componets/Router.sol";
import "./componets/Token.sol";
import "./interfaces/IUniswapInterfaces.sol";


contract MemeForge is ReentrancyGuard {
    ...
    uint256 newVolume,
    uint256 newVolume24H,
    uint256 prevPrice,
    uint256 lastUpdated
    );

    event ETHSwappedForTokens(
        address indexed token,
        address indexed pair,
        address to,
        address referree,
    ...
    constructor(address factory_, address router_, address fee_to, uint256 _fee) {
        ...
        **/
        uniswapV2Router = IUniswapV2Router02(0x94cC0AaC535CCDB3C01d6787D6413C739ae12bc4); // SwapRouter02
    }
    ...
    function launch(
        ...
        emit TokenLaunched(
            ...
            urls[3],
            supply,
            supply / pair_.MINIMUM_LIQUIDITY(),
            pair_.MINIMUM_LIQUIDITY(),
            liquidity * 2,
            0,
            0,
            supply / pair_.MINIMUM_LIQUIDITY(),
    ...
    function swapTokensForETH(uint256 amountIn, address tk, address to, address referree) public returns (bool) {
        ...
        emit TokensSwappedForETH(
            ...
            mCap,
            liquidity,
            token[tk].data.volume,
            token[tk].data.volume24H,
            _price,
            token[tk].data.lastUpdated
        );
